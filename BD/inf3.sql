...
CREATE TABLE `idosos` (
  ...
  `fotoIdoso` varchar(100) NOT NULL,
  `nomeIdoso` varchar(50) NOT NULL,
  `dataNascimentoIdoso` date NOT NULL,
  `telefoneIdoso` varchar(20) NOT NULL,
  `emailIdoso` varchar(50) NOT NULL,
  `senhaIdoso` varchar(100) NOT NULL
...
INSERT INTO `Idosos` (`idIdoso`, `fotoIdoso`, `nomeIdoso`, `dataNascimentoIdoso`, `emailIdoso`, `senhaIdoso`) VALUES
