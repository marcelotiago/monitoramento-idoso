    ...
    while($idoso = mysqli_fetch_assoc($resIdosos)){
        ...
        <div class='col-md-6 col-lg-4 mb-5'>
            <div class='portfolio-item mx-auto' data-bs-toggle='modal' data-bs-target='#portfolioModal$modalCount'>
                ...
                <img class='img-fluid img-idoso d-block mx-auto' src='$fotoIdoso' alt='$nomeIdoso' style='width:180px; height:180px; object-fit:cover; border-radius:50%;' />
                <div class='text-center mt-2 mb-2'><strong>$nomeIdoso</strong></div>
                <div class='d-flex justify-content-center'>
                    <a href='listarRemedios.php?idIdoso=$idIdoso' title='Adicionar Remédio'>
                        <i class='bi bi-clipboard-plus' style='font-size:20px; color: green;'></i>
                    </a>
                </div>
            </div>
        </div>
